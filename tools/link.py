...
VALID_ENVIRONMENTS = ('web', 'webview', 'worker', 'node', 'deno', 'shell', 'worklet')
...
def setup_environment_settings():
  ...
  settings.ENVIRONMENT_MAY_BE_DENO = not settings.ENVIRONMENT or 'deno' in settings.ENVIRONMENT
