...
/*global typeDependencies, setAutoDeleteLater, flushPendingDeletes, getTypeName, getBasestPointer, throwBindingError, UnboundTypeError, embindRepr, registeredInstances, registeredTypes*/
...
var LibraryEmbind = {
  ...
  _embind_register_std_wstring: (rawType, charSize, name) => {
    name = readLatin1String(name);
    var decodeString, encodeString, lengthBytesUTF, HEAP, shift;
    if (charSize === 2) {
